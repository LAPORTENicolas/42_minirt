...
/*   Updated: 2026/02/04 20:03:33 by jodde            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	manage_cone_texture(t_ray_d *r, t_cone *cone)
{
	...
	if (cone->checkboard_flag && cone->hit_type == 0)
		return (cone_checkboard_side(uv, r, cone));
	if (cone->checkboard_flag && cone->hit_type == 1)
